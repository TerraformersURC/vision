...
images_path = os.path.join(package_path, 'config', 'calibration_images')
...
print(f"Directory exists? {os.path.isdir(images_path)}")
...
def main():
    ...
    pass  # replace with your script contents
